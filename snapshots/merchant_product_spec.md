...
**Required** Your product’s unique identifier. Learn more about the [ID ](https://support.google.com/merchants/answer/6324405)[`[id]`](https://support.google.com/merchants/answer/6324405)attribute. **Example** `A2B4` **Syntax** Max 50 characters **Schema.org property** : `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |
...
If no value is specified, the Default `[default]` value is used. **Content**`**[content]**`**(Required)** : The title text. Max 150 characters. **Schema.org property:** **Title**`**[title]**`: `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) **Structured title**`**[structured_title]**`: No |
...
If no value is specified, the Default `[default]` value is used. **Content`[content]` (Required)**: The description text. Max 5000 characters **Schema.org property:** **Description`[description]`:** Yes (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) **Structured description`[structured_description]`:** No |
...
**Required** Your product’s landing page. Learn more about the [Link `[link]`](https://support.google.com/merchants/answer/6324416)attribute. **Example** `http://www.example.com/asp/sp.asp?cat=12&id=1030` **Schema.org property:** `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |
...
**Optional** The URL of an additional image for your product. Learn more about the [Additional image link `[additional_image_link]`](https://support.google.com/merchants/answer/12472826)attribute. **Example** `http://www.example.com/image1.jpg` **Syntax** Max 2000 characters **Schema.org property:** No |
...
**Optional** (available only in the US) Additional link to show a 3D model of your product. Learn more about the [3D model link `[virtual_model_link]`](https://support.google.com/merchants/answer/13674896)attribute. **Example** `https://www.google.com/products/xyz.glb` **Syntax**
...
**Required** Your product's availability. Learn more about the [Availability `[availability]`](https://support.google.com/merchants/answer/12472827)attribute. **Example** `in_stock` **Supported values**
...
* Provide the[ ](https://support.google.com/merchants/answer/6324470)[availability date `[availability_date]` ](https://support.google.com/merchants/answer/6324470)attribute if you submit preorder `[preorder]` or backorder `[backorder]` as the availability value.

### Availability date `[availability_date]`

**Required** if product availability is set to `preorder` The date a preordered product becomes available for delivery. Learn more about the [Availability date `[availability_date]`](https://support.google.com/merchants/answer/6324470) attribute. **Example** (For UTC+1) `2016-02-24T11:07+0100` **Syntax**
...
**Optional** The costs associated with the sale of a particular product as defined by the accounting convention you set up. These costs may include material, labor, freight, or other overhead expenses. By submitting the COGS for your products, you gain insights about other metrics, such as your gross margin and the amount of revenue generated by your ads and free listings. Learn more about the [Cost of goods sold `[cost_of_goods_sold]`](https://support.google.com/merchants/answer/12471621)attribute. **Example** `23.00 USD` **Syntax**
...
**Optional** The date that your product should stop showing. Learn more about the [Expiration date `[expiration_date]`](https://support.google.com/merchants/answer/12471622)attribute. **Example** (For UTC+1) `2016-07-11T11:07+0100` **Syntax**
...
**Required** Your products price. Learn more about the [Price `[price]`](https://support.google.com/merchants/answer/12471842)attribute. **Example** `15.00 USD` **Syntax**
...
**Optional** Your product's sale price. Learn more about the [Sale price `[sale_price]`](https://support.google.com/merchants/answer/12471623) attribute. **Example** `15.00 USD` **Syntax**
...
**Optional** (except when required by local laws or regulations) The measure and dimension of your product as it is sold. Learn more about the [Unit pricing measure `[unit_pricing_measure]`](https://support.google.com/merchants/answer/12471624)attribute. **Example** `1.5kg` **Syntax** Numerical value + unit **Supported units**
...
* For variants:
* Include the same value for [item group ID `[item_group_id]`](https://support.google.com/merchants/answer/6324507) and different values for unit pricing measure.

### Unit pricing base measure `[unit_pricing_base_measure]`

**Optional** (except when required by local laws or regulations) The product’s base measure for pricing (for example, `100ml` means the price is calculated based on a 100ml units). Learn more about the [Unit pricing base measure `[unit_pricing_base_measure]`](https://support.google.com/merchants/answer/6324490)attribute. **Example** `100g` **Syntax** Integer + unit **Supported integers** `1`, `10`, `100`, `2`, `4`, `8` **Supported units**
...
Additional supported metric integer + unit combinations `75cl`, `750ml`, `50kg`, `1000kg` **Schema.org property:** Yes (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central). |
...
**Optional** Details of an installment payment plan. Learn more about the [Installment `[installment]`](https://support.google.com/merchants/answer/12471920)attribute. **Note** :
...
**Example** (implies a 199 EUR down payment and a "finance" credit type) `6:30 EUR:199 EUR` **Syntax** This attribute uses 4 sub-attributes:

* Months `[months]` (Required) Integer, the number of installments the buyer has to pay.
* Amount `[amount]` (Required) ISO 4217, the amount the buyer has to pay per month
* Downpayment `[downpayment]` (Optional, not available in Latin America) ISO 4217, the amount the buyer has to pay upfront as a one time payment. Note: if you don't submit the sub-attribute, the default value is 0 or "no down payment".
...
**Optional** (available only for permitted categories) **For mobile and wireless products** details a monthly or annual payment plan that bundles a communications service contract with a wireless product. **For Physical Goods Subscriptions** details a weekly, monthly, or annual subscription amount for a range of hard goods and physical products that can be delivered to an address. Learn more about the [Subscription cost `[subscription_cost]`](https://support.google.com/merchants/answer/12472643)attribute. **Note** :
...
* Period `[period]` (Required) The duration of a single subscription period. This sub-attribute uses the following supported values:
* Week `[week]`(Physical Goods Subscriptions only)
* Month `[month]`
* Year `[year]`
* Period length `[period_length]` (Required) Integer, the number of subscription periods (weeks, months or years) that the buyer must pay. Must be greater than 0.
...
**Optional** (available for Australia, Japan, United Kingdom, Germany, France, Canada, Mexico, Brazil, and the United States only) The loyalty program `[loyalty_program]` attribute allows setting up of member prices, loyalty points, and loyalty shipping. Learn more about the [Loyalty program `[loyalty_program]` ](https://support.google.com/merchants/answer/12922446)attribute. **Example** `my_loyalty_program:silver:10 USD::10::free_member_shipping` **Syntax** This attribute uses 7 sub-attributes:

* Program label `[program_label]` (Optional for single tier merchants) The loyalty program label set in your loyalty program settings in Merchant Center.
* Tier label `[tier_label]` (Optional for single tier merchants) The tier label set in your program settings in Merchant Center, used to differentiate benefits between each tier.
...
**Optional** The lowest price to which a product's price can be reduced. Google uses this information for features such as sale price suggestions, automated discounts or dynamic promotions. Learn more about the [Minimum price `[auto_pricing_min_price]`](https://support.google.com/merchants/answer/10071801)attribute. **Example** `15.00 USD` **Syntax**
...
**Optional** (available only in IN) Your product’s price. Learn more about the [Maximum retail price `[maximum_retail_price]`](https://support.google.com/merchants/answer/15972291)attribute. **Example** `15.00 INR` **Syntax**

* Numeric
* ISO 4217

**Schema.org property** : No |  Accurately submit the product's maximum retail price and currency, and match with the price from your landing page and at checkout. Make sure that your landing page includes the price in the currency of the target country in a place that's straightforward to find. Don't submit a price of 0 (a price of 0 is allowed for mobile devices sold with a contract).
...
**Optional** Google-defined product category for your product. Learn more about the [Google product category `[google_product_category]`](https://support.google.com/merchants/answer/6324436) attribute. **Example**
...
**Optional** Product category that you define for your product. Learn more about the [Product type `[product_type]`](https://support.google.com/merchants/answer/6324406) attribute. **Example**
...
Your product’s brand name **Required** (For all new products, except movies, books, and musical recording brands) **Optional** for all other products Your product’s brand name. Learn more about the [Brand `[brand]`](https://support.google.com/merchants/answer/12468352)attribute. **Example**
`Google` **Syntax**
...
**It Depends** (strongly recommended if available) Your product’s Global Trade Item Number (GTIN). Learn more about the [GTIN `[gtin]`](https://support.google.com/merchants/answer/12473440) attribute. **Example**
...
Your product’s Manufacturer Part Number (MPN) **Required** (Only if your product does not have a manufacturer assigned GTIN) **Optional** for all other products Your product’s Manufacturer Part Number (MPN). Learn more about the [MPN `[mpn]`](https://support.google.com/merchants/answer/12474954) attribute. **Example**
`GO12345OOGLE` **Syntax**
...
**Optional** Use to indicate whether or not the unique product identifiers (UPIs) GTIN, MPN, and brand are available for your product. Learn more about the [Identifier exists `[identifier_exists]`](https://support.google.com/merchants/answer/12472746) attribute. **Example**
`no` **Supported values**
...
**Required**(If a product contains adult content) Indicate a product includes sexually suggestive content. Learn more about the [Adult `[adult]`](https://support.google.com/merchants/answer/12471844)attribute. **Example** `yes` **Supported values**
...
**Required**(For all apparel products that are targeted to people in Brazil, France, Germany, Japan, the UK, and the US as well as all products with assigned age groups) **Required** for free listings for all `Apparel & Accessories` (ID: `166`) products**** **Optional** for all other products and target countries The demographic for which your product is intended. Learn more about the [Age group `[age_group]`](https://support.google.com/merchants/answer/12472028)attribute. **Example** `infant` **Supported values**

* Newborn `[newborn] `0-3 months old
* Infant `[infant] `3-12 months old
* Toddler `[toddler] `1-5 years old
* Kids `[kids] `5-13 years old
* Adult `[adult] `Teens or older
...
**Required** for products that require certain certification information to be shown in your Shopping ads or free listings, for example due to local energy efficiency labeling regulations**** **Optional** for all other products Certifications, such as energy efficiency ratings, associated with your product. Available for the EU and EFTA countries and the UK. [Certification `[certification]`](https://support.google.com/merchants/answer/13528839). **Note** : Starting April 2025, for products targeting countries in the European Union and that are required to show graphical energy efficiency class labels, use the [certification `[certification]`](https://support.google.com/merchants/answer/13528839) attribute, which references the necessary graphical energy efficiency source data through the EU [EPREL](https://eprel.ec.europa.eu/screen/home) database. The [energy efficiency class `[energy_efficiency_class]`](https://support.google.com/merchants/answer/7562785) attributes are now only available for products that target Switzerland, Norway, or the United Kingdom. **Example** `EC:EPREL:123456` **Syntax** This attribute uses the following sub-attributes:
...
**Schema.org property** : No |  Consult EU energy efficiency regulations or any applicable local law to determine if you need to provide this attribute. This includes products covered by [EU energy labels](https://energy-efficient-products.ec.europa.eu/product-list_en), for example:
...
**Required**(Required for all apparel items that are targeted to people in Brazil, France, Germany, Japan, the UK, and the US as well as all gender-specific products) **Required** for free listings for all Google `Apparel & Accessories` (ID: `166`) products**** **Optional** for all other products and target countries The gender for which your product is intended. Learn more about the [Gender `[gender]`](https://support.google.com/merchants/answer/12471626)attribute. **Example** `Unisex` **Supported values**
...
**Required**(For all apparel products that are targeted to Brazil, France, Germany, Japan, the UK, and the US as well as all products available in different colors) **Required** for free listings for all `Apparel & Accessories` (ID: `166`) products**** **Optional** for all other products and target countries Your product’s color(s). Learn more about the [Color `[color]`](https://support.google.com/merchants/answer/12471922)attribute. **Example** Black **Syntax** Max 100 alphanumeric characters (max 40 characters per color) **Schema.org property** : `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |
...
**Required** if your product is used or refurbished **Optional** for new products The condition of your product at time of sale. Learn more about the [Condition `[condition]`](https://support.google.com/merchants/answer/12471921)attribute. **Example** `new` **Supported values**

* New `[new] `Brand new, original, unopened packaging
* Refurbished `[refurbished] `Professionally restored to working order, comes with a warranty, may or may not have the original packaging
* Used `[used] `Previously used, original packaging opened or missing

**Schema.org property** : `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |

### Document link `[document_link]`

**Optional** The URL to a PDF document about your product.Learn more about the [Document link`[document_link]` ](https://support.google.com/merchants/answer/17084656)attribute. **Example** `https://example.com/manual.pdf` **Syntax** URL (Must start with "http://" or "https://") Max 5 values Up to 2000 characters **Schema.org propert** y: No |  For the URL:
...
**Required**(Brazil, France, Germany, Japan, the United Kingdom, and the US if the product is a variant) **Required** for free listings for all product variants**** **Optional** for all other products and target countries ID for a group of products that come in different versions (variants). Learn more about the [Item group ID `[item_group_id]`](https://support.google.com/merchants/answer/12472646) attribute. **Example** `AB12345` **Syntax** Max 50 alphanumeric characters **Schema.org property** : `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |
...
* Specify the [color `[color]`](https://support.google.com/merchants/answer/6324487),[ pattern `[pattern]`](https://support.google.com/merchants/answer/6324483),[ material`[material]`](https://support.google.com/merchants/answer/6324410),[ age group `[age_group]`](https://support.google.com/merchants/answer/6324463),[ gender `[gender]`](https://support.google.com/merchants/answer/6324463), and [size `[size]`](https://support.google.com/merchants/answer/6324492) attributes in addition to variant option `[variant_option]` when these attributes are part of the set of variant-identifying properties.

### Item group title `[item_group_title]`

**Optional** , use if the product is a variant A title for the parent product (product group) to which this variant belongs. Learn more about the [Item group title `[item_group_title]`](https://support.google.com/merchants/answer/17085146)attribute. **Example** My Brand Brilliance line Laptop **Syntax** Text. Max 150 characters **Schema.org property** : No |
...
**Required** (if relevant for distinguishing different products in a set of variants)**** **Optional** for all other products Your product’s fabric or material. Learn more about the [Material `[material]`](https://support.google.com/merchants/answer/12472145) attribute. **Example** `leather` **Syntax** Max 200 characters **Schema.org property** : `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |
...
**Optional** (except when required by local laws or regulations) The minimum energy efficiency class in this products's category. Only available for products that target Switzerland, Norway, or the United Kingdom. Learn more about the [Minimum energy efficiency class `[min_energy_efficiency_class]`](https://support.google.com/merchants/answer/12472144) attribute. **Note** : Starting April 2025, the [minimum energy efficiency class `[min_energy_efficiency_class]`](https://support.google.com/merchants/answer/12472144) attribute is only available for products that target Switzerland, Norway, or the United Kingdom and are not sold in the EU. For products targeting countries in the European Union and are required to show the graphical energy efficiency class, use the [certification `[certification]`](https://support.google.com/merchants/answer/13528839) attribute, which references the necessary graphical energy efficiency source data from the EU through the [EPREL](https://eprel.ec.europa.eu/screen/home) database. **Example** `A+++` **Supported values**
...
**Optional** (except when required by local laws or regulations) The maximum energy efficiency class in this product's category. Only available for products that target Switzerland, Norway, or the United Kingdom. Learn more about the [Maximum energy efficiency class `[max_energy_efficiency]`](https://support.google.com/merchants/answer/12472144) attribute. **Note** : Starting April 2025, the [maximum energy efficiency class `[max_energy_efficiency]`](https://support.google.com/merchants/answer/12472144) attribute is only available for products that target Switzerland, Norway, or the United Kingdom and are not sold in the EU. For products targeting countries in the European Union and are required to show the graphical energy efficiency class, use the [certification `[certification]`](https://support.google.com/merchants/answer/13528839) attribute, which references the necessary graphical energy efficiency source data from the EU through the [EPREL](https://eprel.ec.europa.eu/screen/home) database. **Example** `D` **Supported values**
...
**Required** (For multipack products in Australia, Brazil, Czechia, France, Germany, Italy, Japan, Netherlands, Spain, Switzerland, the UK and the US) **Required** for free listings on Google if you’ve created a multipack**** **Optional** for all other products and target countries The number of identical products sold within a merchant-defined multipack. Learn more about the [Multipack `[multipack]`](https://support.google.com/merchants/answer/12472336) attribute. **Example** `6` **Syntax** Integer **Schema.org property** : No |
...
**Required** (if relevant for distinguishing different products in a set of variants)**** **Optional** for all other products Your product’s pattern or graphic print. Learn more about the [Pattern `[pattern]`](https://support.google.com/merchants/answer/12472146) attribute. **Example**

* `Striped`
* `polka dot`
* `paisley`

**Syntax** Max 100 characters **Schema.org property** : `Yes` (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |  For variants:
...
**Optional** The popularity of the product as assessed by you. Learn more about the [Popularity rank `[popularity_rank]`](https://support.google.com/merchants/answer/17085297)attribute. **Example** `76.5` **Syntax** Float **Range** 0-100.0
...
**Optional** Technical specifications or additional details of your product. Learn more about the [Product detail `[product_detail]`](https://support.google.com/merchants/answer/9218260) attribute. **Example** `General:Product Type:Digital player` **Syntax** This attribute uses 3 sub-attributes:
...
* Do not repeat information already provided in [product highlight `[product_highlight]`](https://support.google.com/merchants/answer/12471629), [Question and answer `[question_and_answer]`](https://support.google.com/merchants/answer/12471629), or [description `[description]`](https://support.google.com/merchants/answer/6324468).

### Product length `[product_length]`

**Optional** Your product's length. Learn more about the [Product length `[product_length]`](https://support.google.com/merchants/answer/12472549) attribute. **Example** `20 in` **Syntax** Number + unit **Supported values** `1-3000`
...
**Optional** Your product's width. Learn more about the [Product width `[product_width]`](https://support.google.com/merchants/answer/12472549) attribute. **Example** `20 in` **Syntax** Number + unit **Supported values** `1-3000`
...
**Optional** Your product's height. Learn more about the [Product height `[product_height]`](https://support.google.com/merchants/answer/12472549) attribute. **Example** `20 in` **Syntax** Number + unit **Supported values** `1-3000`
...
**Optional** The most relevant highlights of your products. Learn more about the [Product highlight `[product_highlight]`](https://support.google.com/merchants/answer/12471629) attribute. **Example** `Supports thousands of apps, including Netflix, YouTube, and HBO Max` **Syntax** Max 150 characters **Schema.org property** : No |
...
* Do not repeat information already provided in [product detail `[product_detail]`](https://support.google.com/merchants/answer/9218260), [Question and answer`[question_and_answer]`](https://support.google.com/merchants/answer/9218260)or [description `[description]`](https://support.google.com/merchants/answer/6324468).

### Product weight `[product_weight]`

**Optional** Your product's weight. Learn more about the [Product weight `[product_weight]`](https://support.google.com/merchants/answer/12472549) attribute. **Example** `3.5 lb` **Syntax** Number + unit **Supported values** `0-2000`
...
**Optional** User-, merchant-, and manufacturer-authored questions and answers about the product. Learn more about the [Question and answer `[question_and_answer]`](https://support.google.com/merchants/answer/17085211) attribute. **Example (2 Q &As)**: `"Does it have a headphone jack?":"This version doesn’t have a headphone jack.", ` `"Does it support Bluetooth?":"It has full Bluetooth 6.0 support." ` **Syntax** Group attribute. Max 30 values. Max 10000 characters total. This attribute uses 2 sub-attributes (both are required):
...
* Don't add information covered in other attributes, all capital letters, gimmicky foreign characters, promotion text, or list keywords or search terms.
* Don’t add information such as price, sale price, sale dates, shipping, delivery date, other time-related information, or your company’s name. Do not repeat information already provided in [product detail `[product_detail]`](https://support.google.com/merchants/answer/9218260),[product highlight `[product_highlight]`](https://support.google.com/merchants/answer/12471629) or [ description `[description]`](https://support.google.com/merchants/answer/6324468).

### Related product `[related_product]`

**Optional** Specifies how other products are related to this product. Learn more about the [Related product `[related_product]`](https://support.google.com/merchants/answer/17085213)attribute. **Example** `required_part:id:AZ7A, required_part:id:AZ7B, accessory:gtin:811571013579` **Syntax** Group attribute. Max 30 values This attribute uses three sub-attributes (all three are required):

* **Relationship type`[relationship_type]`**. This sub-attribute supports the following values:
* **Part of set**`**[part_of_set]** `Part of a set of products that are often purchased together
* **Required part**`**[required_part]** `Part that is necessary for the product to function, for example a battery for a battery-operated lamp.
* **Often bought with**`**[often_bought_with]** `A product that this product is often purchased together with, for example a phone case with a phone.
* **substitute**`**[substitute]** `Product that this product can be substituted for, for example a cheaper alternative.
* **Different brand**`**[different_brand]** `An identical product sold under a different brand, for example a cheaper house brand.
* **Accessory**`**[accessory]** `An accessory to this product, for example a side table that matches the style of a couch.
* **Identifier type`[identifier_type]`**. This sub-attribute supports the following values:
* **GTIN`[gtin] `**The identifier is a GTIN
* **ID**`**[id]** `The identifier is a product ID in the feed
...
**Required** (Required for all apparel products in `Apparel & Accessories > Clothing` (ID:`1604`) and `Apparel & Accessories > Shoes` (ID:`187`) categories targeted to people in Brazil, France, Germany, Japan, the UK, and the US as well as all products available in different sizes) **Required** for free listings for all `Apparel & Accessories > Clothing` (ID:`1604`) and `Apparel & Accessories > Shoes` (ID:`187`) products**** **Optional** for all other products and target countries Your product’s size. Learn more about the [Size `[size]`](https://support.google.com/merchants/answer/12471627) attribute. **Example** `XL` **Syntax** Max 100 characters **Schema.org property** : Yes (Learn more about [Merchant listing (Product, Offer) structured data](https://developers.google.com/search/docs/appearance/structured-data/merchant-listing) on Google Search Central) |
...
* For merchant-defined multipack products, submit the multipack quantity using the multipack `[multipack]` attribute. Don't submit the multipack quantity under the size attribute.

### Size type `[size_type]`

**Optional** (Available for apparel products only) Your apparel product’s cut. Learn more about the [Size type `[size_type]`](https://support.google.com/merchants/answer/12471628) attribute. **Example** `maternity` **Supported values**
...
**Optional** (Available for apparel products only) The country of the size system used by your product. Learn more about the [Size system `[size_system]`](https://support.google.com/merchants/answer/12472828) attribute. **Example** `US` **Supported values**
...
**Optional**. Use if the product is a variant Variant-identifying dimensions and their values. Learn more about the [Variant option `[variant option]` ](https://support.google.com/merchants/answer/17085214)attribute. **Example** `Memory size:128 GB,Screen size:XL` **Syntax** Group attribute. Max 30 values. Max 5000 characters total. This attribute uses two sub-attributes (both are required):
...
**Optional** A URL used to specify additional parameters for your product page. Customers will be sent to this URL rather than the value that you submit for the link `[link]` or mobile link `[mobile_link]` attributes. Learn more about the;[Ads redirect `[ads_redirect]`](https://support.google.com/merchants/answer/6324450)attribute. **Example**
...
**Optional** Label that you assign to a product to help organize bidding and reporting in Shopping campaigns. Learn more about the [Custom label 0-4 `[custom_label_0-4]`](https://support.google.com/merchants/answer/6324473) attribute. **Example**
...
**Optional** (Required for promotions in Australia, France, Germany, India, the UK and the US) An identifier that allows you to match products to promotions. Learn more about the [Promotion ID `[promotion_id]`](https://support.google.com/merchants/answer/7050148) attribute. **Example**
`ABC123` **Syntax**
...
**Optional** Attribute used to include the URL for a lifestyle image for your product Only available for browsy surfaces. Learn more about the [Lifestyle image link `[lifestyle_image_link]`](https://support.google.com/merchants/answer/9103186)attribute. **Example** `https://www.example.com/image1.jpg` **Syntax** Max 2000 characters **Schema.org property** : No |
...
**Optional** Short product name. Learn more about the [Short title `[short_title]`](https://support.google.com/merchants/answer/11551083) attribute. Only available for Demand Gen Ads, including YouTube, Gmail, Maps, Discover app, Google Display Network, and Google Video Partners. Learn more [About Demand Gen campaigns](https://support.google.com/google-ads/answer/13695777). **Example**
...
**Required** for multi-seller account Used by a marketplace to externally identify a seller. (For example, on a website). Learn more about the [External seller ID `[external_seller_id]`](https://support.google.com/merchants/answer/11537846) attribute **Example** `SellerPublicName1991` **Syntax** 1 - 50 characters **Schema.org property** : No |
...
Attributes and format | Minimum requirements at a glance
---|---

### Excluded destination `[excluded_destination]`

**Optional** A setting that you can use to exclude a product from participating in a specific type of advertising campaign. Learn more about the [Excluded destination `[excluded_destination]`](https://support.google.com/merchants/answer/12472337) attribute. **Example**
...
* The excluded destination `[excluded_destination] `and the included destination `[included_destination]` attributes are mutually exclusive.
* If both attributes have conflicting information, the excluded destination `[excluded_destination] `attribute takes precedent.
* Only use the excluded destination `[excluded_destination]` attribute for products you want to exclude for an extended time.
* If you want to temporarily stop a product from showing,, use the pause `[pause]` attribute instead.

### Included destination `[included_destination]`

**Optional** A setting that you can use to include a product in a specific type of advertising campaign. Learn more about the [Included destination `[included_destination]`](https://support.google.com/merchants/answer/12472550) attribute. **Example**
`Shopping_ads` **Supported values**
...
* The excluded destination `[excluded_destination] `and the included destination `[included_destination]` attributes are mutually exclusive.
* If both attributes have conflicting information, the excluded destination `[excluded_destination]` takes precedent.

### Excluded countries for Shopping ads `[shopping_ads_excluded_country]`

A setting that allows you to exclude countries where your products are advertised on Shopping ads **Optional** Only available for Shopping ads. A setting that allows you to exclude countries where your products are advertised on Shopping ads. Learn more about the [Excluded countries for Shopping ads](https://support.google.com/merchants/answer/9837523) `[shopping_ads_excluded_country] `attribute. **Example**
DE **Syntax**
...
**Optional** A setting you can use to pause and quickly reactivate a product for all ads (including Shopping ads, Display ads, and local inventory ads). A product can be paused for up to 14 days. If a product is paused for more than 14 days it will be disapproved. To re-approve, remove the attribute. Learn more about the [Pause `[pause]`](https://support.google.com/merchants/answer/12472831) attribute. **Example**
`ads` **Supported values**
`ads` `all` **Schema.org property** : No |

* Submit the attribute with a supported value.
* Only pause a product for 14 days or less. If you need to stop showing your product for more than 14 days, use the excluded destination `[excluded_destination]` attribute.
* Use the excluded destination `[excluded_destination]` attribute for products you want to pause only for free listings.
* Avoid using availability to pause ads or free listings. Don't attempt to set the availability `[availability]` attribute to “out_of_stock” to pause your products.
